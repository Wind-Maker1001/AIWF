...
#[derive(Deserialize)]
struct AggregateRowsV3Req {
    run_id: Option<String>,
    rows: Vec<Value>,
    group_by: Vec<String>,
    aggregates: Vec<Value>,
    approx_sample_size: Option<usize>,
}
...
struct JoinRowsV4Req {
    ...
    spill_path: Option<String>,
    chunk_size: Option<usize>,
    enable_bloom: Option<bool>,
    bloom_field: Option<String>,
}

#[derive(Deserialize)]
struct AggregateRowsV4Req {
    run_id: Option<String>,
    rows: Vec<Value>,
    group_by: Vec<String>,
    aggregates: Vec<Value>,
    approx_sample_size: Option<usize>,
    verify_exact: Option<bool>,
    parallel_workers: Option<usize>,
}

#[derive(Deserialize)]
struct QualityCheckV4Req {
    run_id: Option<String>,
    rows: Vec<Value>,
    rules: Value,
    rules_dsl: Option<String>,
...
fn run_transform_rows_v2_with_cache(
...
fn run_transform_rows_v2_with_cancel(
    ...
    // Expression engine + vectorized text/date transforms on normalized rows.
...
fn collect_expr_lineage(expr: &Value, out: &mut HashSet<String>) {
...
fn run_transform_rows_v3(req: TransformRowsV3Req) -> Result<TransformRowsResp, String> {
...
fn parse_join_keys(v: &Value) -> Result<Vec<String>, String> {
...
fn join_key_multi(obj: &Map<String, Value>, keys: &[String]) -> String {
    keys.iter()
...
fn run_join_rows_v2(req: JoinRowsV2Req) -> Result<JoinRowsResp, String> {
...
fn run_join_rows_v3(req: JoinRowsV3Req) -> Result<JoinRowsResp, String> {
...
fn parse_percentile_op(op: &str) -> Option<f64> {
...
fn run_aggregate_rows_v2(req: AggregateRowsV2Req) -> Result<AggregateRowsResp, String> {
    let specs = parse_agg_specs(&req.aggregates)?;
...
fn approx_percentile(mut vals: Vec<f64>, p: f64, sample_size: usize) -> Option<f64> {
    if vals.is_empty() {
        return None;
    }
...
fn aggregate_group_v3(
    ...
    for spec in specs {
        ...
        match op.as_str() {
            ...
            _ => {
                if let Some(p) = parse_tdigest_percentile(&op) {
                    obj.insert(
                        as_name,
...
fn run_aggregate_rows_v3(req: AggregateRowsV3Req) -> Result<AggregateRowsResp, String> {
...
fn run_quality_check_v2(req: QualityCheckV2Req) -> Result<QualityCheckResp, String> {
...
fn run_quality_check_v3(req: QualityCheckV3Req) -> Result<QualityCheckResp, String> {
...
fn run_lineage_v2(req: LineageV2Req) -> Result<Value, String> {
...
fn run_join_rows_v4(req: JoinRowsV4Req) -> Result<JoinRowsResp, String> {
    let left_keys = parse_join_keys(&req.left_on)?;
    let right_keys = parse_join_keys(&req.right_on)?;
...
fn run_aggregate_rows_v4(req: AggregateRowsV4Req) -> Result<AggregateRowsResp, String> {
...
fn run_quality_check_v4(req: QualityCheckV4Req) -> Result<QualityCheckResp, String> {
...
fn run_lineage_v3(req: LineageV3Req) -> Result<Value, String> {
