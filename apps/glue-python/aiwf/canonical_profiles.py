...
DEFAULT_HEADER_ALIASES: dict[str, list[str]] = {
    ...
    "txn_date": ["txn_date", "transaction_date", "posting_date", "交易日期", "记账日期", "入账日期", "日期"],
    ...
    "txn_type": ["txn_type", "transaction_type", "交易类型", "业务类型", "方向", "借贷方向", "借贷标志", "收支方向"],
    "customer_name": ["customer_name", "customer", "name", "客户", "客户名称", "姓名", "联系人", "联系人姓名"],
    "phone": ["phone", "mobile", "tel", "telephone", "手机号", "手机", "电话号码", "联系电话", "座机"],
    ...
    "speaker_role": ["speaker_role", "speaker type", "speaker_type", "发言角色"],
    "argument_role": ["argument_role", "claim_type", "argument type", "论证角色"],
    "source_domain": ["source_domain", "domain", "host", "来源域名"],
    "citation_text": ["citation_text", "citation", "ref_text", "引用"],
    "quote_text": ["quote_text", "quote", "quoted_text", "引文正文"],
    "debate_topic": ["debate_topic", "topic", "议题", "主题"],
...
PROFILE_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "bank_statement": {
        ...
        "header_aliases": {
            ...
            "txn_type": ["交易类型", "业务类型", "方向", "借贷方向", "借贷标志", "收支方向"],
            "currency": ["币种", "货币", "结算币种"],
        },
    },
    "customer_contact": {
    ...
    "debate_evidence": {
        "required_fields": ["claim_text", "source_path"],
        "string_fields": [
            "claim_text",
            "speaker",
            "speaker_role",
        ...
        "unique_keys": ["source_path", "speaker", "source_domain", "claim_text"],
        "defaults": {},
        "header_aliases": {
            ...
            "speaker_role": ["发言角色", "speaker role", "speaker type"],
            "argument_role": ["论证角色", "argument role", "claim type"],
            "source_domain": ["来源域名", "source domain", "host"],
            "citation_text": ["引用", "citation", "ref text"],
            "quote_text": ["引文正文", "quote", "quoted text"],
            "debate_topic": ["议题", "主题", "topic"],
            "language": ["语言", "lang", "language"],
            "stance": ["立场", "态度"],
        },
    },
}
