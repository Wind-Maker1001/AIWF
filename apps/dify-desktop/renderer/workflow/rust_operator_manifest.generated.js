...
export const RENDERER_RUST_OPERATOR_MANIFEST_VERSION = "v1";
export const RENDERER_RUST_OPERATOR_MANIFEST_AUTHORITY = "rust_operator_catalog";
export const RENDERER_RUST_OPERATOR_SCHEMA_PATH = "contracts\\rust\\operators_manifest.schema.json";
export const RENDERER_RUST_OPERATOR_SOURCE_INPUTS = Object.freeze(["apps/accel-rust/src/operator_catalog_data.rs","apps/accel-rust/src/operators/workflow/engine.rs"]);
export const KNOWN_RUST_OPERATOR_METADATA = deepFreeze({
...
export const DESKTOP_RUST_OPERATOR_METADATA = deepFreeze({
  "aggregate_rows_v2": {
    "operator": "aggregate_rows_v2",
    "version": "v2",
    "domain": "analytics",
