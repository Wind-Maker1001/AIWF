...
| Sandbox alerts / rules / autofix management | partial (`compat-hidden`) | `renderer/workflow/sandbox-*.js`, `panels-ui-governance-*` | partial | backendize policy engine/versioning; keep rule editing, mute, and override UI in frontend | governance/backend + frontend | 2026-05-19 | WinUI sandbox rules/autofix editor plus preset apply/import/export parity landed on 2026-06-01; remaining gap is sandbox alert aggregation/health parity and sandbox audit export parity |
