...
| Audit timeline / failure summary / review history | partial (`compat-hidden`) | `renderer/workflow/audit-*.js`, `review-queue-*.js` | partial | backendize audit/query model; frontend consumes query APIs | governance/backend | 2026-04-19 | WinUI timeline/failure/audit viewer plus governance audit export and review history filters/export landed by 2026-05-29; remaining gap is offline_local mirror retirement and any broader governance-only export/report surfaces |
