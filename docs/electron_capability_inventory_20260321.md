...
| Baseline compare / lineage helper surfaces | partial (`compat-hidden`) | `renderer/workflow/support-ui-*.js` | partial | backendize lineage/compare computation; frontend remains a viewer/filter surface | workflow/governance backend + frontend | 2026-05-19 | WinUI baseline list/save/compare viewer plus compare report and lineage export parity landed on 2026-05-29; remaining gap is historical lineage persistence/query parity |
