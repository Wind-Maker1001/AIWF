...
| --- | --- | --- |
| Workflow Studio compatibility entrypoint | keep only as a workflow-studio-only script/argv compatibility launcher while residual legacy use exists | keep off default in-app menu and no new primary user features |
