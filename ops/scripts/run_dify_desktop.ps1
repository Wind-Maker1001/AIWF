...
if (-not $SkipEnsureGlueBridge) {
  ...
  Info "default compatibility launch will use backend-owned manual review, quality rule, app registry, workflow version, run audit, and run baseline providers"
} else {
